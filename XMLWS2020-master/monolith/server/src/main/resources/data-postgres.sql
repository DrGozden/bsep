...
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, status) VALUES ('agnt', '$2a$10$ylGUku/7LMzk.WZBqQU/uueutyKJVcRtVJkiTbts8VhPQuIXJfAhe', 'Marko', 'Markovic', 'user@example.com', true, '2017-10-01 21:58:58.508-07', 'BLOK');
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, status) VALUES ('admin', '$2a$10$ylGUku/7LMzk.WZBqQU/uueutyKJVcRtVJkiTbts8VhPQuIXJfAhe', 'Nikola', 'Nikolic', 'admin@example.com', true, '2017-10-01 18:57:58.508-07', 'ACTIVE');
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, status) VALUES ('user', '$2a$10$ylGUku/7LMzk.WZBqQU/uueutyKJVcRtVJkiTbts8VhPQuIXJfAhe', 'Maja', 'Savic', 'kupac@example.com', true, '2017-10-01 18:57:58.508-07', 'ACTIVE');
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, status) VALUES ('peraSaKlise', '$2a$10$ylGUku/7LMzk.WZBqQU/uueutyKJVcRtVJkiTbts8VhPQuIXJfAhe', 'Pera', 'Peric', 'prea@gmail.com', true, '2017-10-01 18:57:58.508-07', 'ACTIVE');
INSERT INTO USERS (username, password, first_name, last_name, email, enabled, last_password_reset_date, status) VALUES ('maraSmara' ,'$2a$10$ylGUku/7LMzk.WZBqQU/uueutyKJVcRtVJkiTbts8VhPQuIXJfAhe', 'Mara', 'Maric', 'merry@gmail.com', true, '2017-10-01 18:57:58.508-07' , 'ACTIVE');
