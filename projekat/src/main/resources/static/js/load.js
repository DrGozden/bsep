function loadCertificate(){
	...
	$.ajax({
		...
		success : function(data) {
			...
			$("#version").append("<div><label>Version:</label><label id = \"version\">"+data.version+"</label></div>");
			$("#serialNumber").append("<div> <label>Serial Number:</label><label id = \"serialNumber\">"+data.certificateDataSN+"</label></div>");
			$("#sa").append("<div><label>Signature Algorithm:</label><label id = \"sa\">"+data.signatureAlg+"</label></div>");
